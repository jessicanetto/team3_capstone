class f {
  ...
  static listCameras(a = !1) {
    ...
    return (
      ...
      .then((a) => a.filter((a) => "videoinput" === a.kind).map((a, b) => ({ id: a.deviceId, label: a.label || (0 === b ? "Default Camera" : `Camera ${b + 1}`) })))
      .finally(() => {
  ...
  turnFlashOn() {
    ...
    return !this._active || this._paused
      ? Promise.resolve()
      : this.hasFlash()
          .then((a) => (a ? this.$video.srcObject.getVideoTracks()[0].applyConstraints({ advanced: [{ torch: !0 }] }) : Promise.reject("No flash available")))
          .catch(() => {
            this._flashOn = !1;
            throw e;
          });
  ...
  setGrayscaleWeights(a, b, c, d = !0) {
    f._postWorkerMessage(this._qrEnginePromise, "grayscaleWeights", { red: a, green: b, blue: c, useIntegerApproximation: d });
  }
  setInversionMode(a) {
    ...
    requestAnimationFrame(() => {
      1 >= this.$video.readyState
        ...
        : this._qrEnginePromise
            .then((a) => f.scanImage(this.$video, this._scanRegion, a, this.$canvas))
  ...
  _getCameraStream() {
    ...
    return [...b.map((b) => Object.assign({}, b, { [a]: { exact: this._preferredCamera } })), ...b].reduceRight(
      (a, b) => () =>
        navigator.mediaDevices
          .getUserMedia({ video: b, audio: !1 })
          .then((a) => ({ stream: a, facingMode: this._getFacingMode(a) || (b.facingMode ? this._preferredCamera : "environment" === this._preferredCamera ? "user" : "environment") }))
          .catch(a),
  ...
  static _drawToCanvas(a, b = null, c = null, d = !1) {
    ...
    d || ((d = b && b.downScaledWidth ? b.downScaledWidth : k), (b = b && b.downScaledHeight ? b.downScaledHeight : l), c.width !== d && (c.width = d), c.height !== b && (c.height = b));
